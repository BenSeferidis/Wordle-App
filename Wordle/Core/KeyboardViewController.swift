...
class KeyboardViewController: UIViewController {
    ...
    weak var deleagate: KeyboardViewControllerDelegate?
...
extension KeyboardViewController : UICollectionViewDelegateFlowLayout ,UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
        ...
        let inset: CGFloat = (collectionView.frame.width - (size * count) - (2 * count))/2
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let letter = keys[indexPath.section][indexPath.row]
        deleagate?.keyboardViewController(self, didTapKey: letter)
    }
}
